...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1T48XecE9G?p=169)
...
|yaopinbianhao|varchar(200)|是|NULL|药品编号|
|yaopinmingcheng|varchar(200)|是|NULL|药品名称|
|pinpai|varchar(200)|是|NULL|品牌|
|baosunshijian|datetime|是|NULL|报损时间|
|baosunshuliang|int(11)|是|NULL|报损数量|
|yuanyinshuoming|longtext|是|NULL|原因说明|
表4.2 出库记录信息表
...
|chukushuoming|longtext|是|NULL|出库说明|
|yaopinbianhao|varchar(200)|是|NULL|药品编号|
|yaopinmingcheng|varchar(200)|是|NULL|药品名称|
...
|addtime|timestamp|否|CURRENT\_TIMESTAMP|创建时间|
|shuliang|int(11)|是|NULL|数量|
|rukushuoming|longtext|是|NULL|入库说明|
|yaopinbianhao|varchar(200)|是|NULL|药品编号|
|yaopinmingcheng|varchar(200)|是|NULL|药品名称|
|leibie|varchar(200)|是|NULL|类别|
|pinpai|varchar(200)|是|NULL|品牌|
...
|xiaoshoushuoming|longtext|是|NULL|销售说明|
